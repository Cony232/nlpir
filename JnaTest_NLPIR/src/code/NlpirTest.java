...
public class NlpirTest {
	...
	public interface CLibrary extends Library {
		...
		CLibrary Instance = (CLibrary) Native.loadLibrary(
				"E:\\work\\nlpir\\JnaTest_NLPIR\\file\\win64\\NLPIR", CLibrary.class);
	...
	public static void main(String[] args) throws Exception {
		...
		List<String> txtList=Txt2String.readFileByLines("E:\\work\\animal\\train\\1.txt");
		//String sInput = "据悉，质检总局已将最新有关情况再次通报美方，要求美方加强对输华玉米的产地来源、运输及仓储等环节的管控措施，有效避免输华玉米被未经我国农业部安全评估并批准的转基因品系污染。";

		//String nativeBytes = null;
		try {
			List<String> list=new ArrayList<String>();
			int num=CLibrary.Instance.NLPIR_ImportUserDict("E:\\work\\nlpir\\JnaTest_NLPIR\\file\\animal.txt", true);
		System.out.println(num);
			//	CLibrary.Instance.NLPIR_ImportUserDict("file/math.txt", false);
			for (String sInput : txtList) {
				nativeBytes = CLibrary.Instance.NLPIR_ParagraphProcess(sInput, 0);
				//System.out.println("分词结果为： " + nativeBytes);
				list.add(nativeBytes);
				
			//	CLibrary.Instance.NLPIR_AddUserWord("口蹄疫");
...
//				String nativeByte = CLibrary.Instance.NLPIR_GetKeyWords(sInput, 10,false);
			 ...
			 String2Txt.writeFileByLines("E:\\work\\animal\\fenci\\1.txt",list);
